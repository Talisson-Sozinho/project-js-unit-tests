...
Projeto feito por mim ao final do bloco 7 do curso da [trybe](https://www.betrybe.com/) para fixar e avaliar os conhecimento adquiridos no bloco.
...
## Caso queira uma cópia:

1. Clone o repositório
  * `git clone git@github.com:Talisson-Sozinho/project-js-unit-tests.git`.
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-021-b-project-js-unit-tests`

2. Instale as dependências
  * `npm install`

## Requisitos seguidos para a realização do projeto

**As funções e teste que não foram requeridos nos comando abaixo, foi disponibilizado no template do projeto fornecido pela Trybe**
